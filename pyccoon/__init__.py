...
documentation generator. It produces HTML that displays your comments alongside your code.
Comments are passed through [Markdown](http://daringfireball.net/projects/markdown/syntax),
while the code is processed by [Pygments](http://pygments.org/) for syntax highlighting.
